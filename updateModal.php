  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-edit"></i> UPDATE PET'S</h4>
      </div>
...
<div class="col-lg-2">
  ...
  <div class="col-lg-2">
   ...
   <div class="col-lg-10">
    <img src="<?php echo $image;?>" width="200px;" class="img-responsive img-rounded" style="margin-bottom:10px;">
...
//
				...
				$sql = ("UPDATE tblcnp set name = '$name',
													   ...
													   status = '$stat',
													   prize = '$prize',
													   image_p = '$location' WHERE id = '$id'") or die (mysqli_error());
