            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:Pink;">
                        <!--      <img src="images/logo.jpg"  width="15% "/> -->PET'S WORLD</h4></a>
                </div>
...
<div class="container">
        <section id="contact-info">
                ...
                <img src="images/ANSH1.jpg" class="img-responsive pull-right" />
            <div class="left wow fadeInDown">
                
               <div class="col-md-6">
               <img src="images/panda.jpg" class="img-responsive pull-right" />
               </div> 
               <div class="col-md-6">
                <p class="lead">
                    <br>
                    <p><span style="font-size:20px; font-weight:bold; font-family:verdana; color:red;">PET'S WORLD</span>
                    <br><b>Address:</b> Gloria City Plot 67, N-4 Cidco<b><br>Tel/Phone:</b> +91-9988776655<b>
                        <br>Email Address:</b> ansh_r@gmail.com</p>
                    <hr>
                    <span style="font-size:20px; font-weight:bold; font-family:verdana; color:Violet;">Contact Now</span>
