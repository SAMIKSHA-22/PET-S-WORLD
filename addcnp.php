                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown active"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> Product <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                              ...
                              <li><a href="update_cnp.php"> Update Pet Data </a></li>

                              <li><a href="addcnp_mat.php"> Add Pet_mats</a></li>
                              <li><a href="update_cnp_mat.php"> Update Pet_mat Data </a></li>

                              <li><a href="addcnp_food.php"> Add Pet_feed</a></li>
                              <li><a href="update_cnp_food.php"> Update Pet_feed Data </a></li>
                            </ul>
                        </li>
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2019 <a target="_blank" href="#" title="#">Petshop Online Websit</a>. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
