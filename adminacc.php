...
<head>
    ...
    <title>ADMIN | Petshop Online </title>
...
<div class="container wow fadeInDown">
    <div class="row">
        ...
        <center><img src="avtar.JPG" class="img-responsive wow fadeInDown" style="height:200px;" /></center>
        <div>
            <?php
                session_start();
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2022 petshop online. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
